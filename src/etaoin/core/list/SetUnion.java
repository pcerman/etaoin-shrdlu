...
public class SetUnion extends Func {

    public static enum FType { SET_UNION, SETQ_UNION }

    private final FType ftype;

    public SetUnion(FType ftype) {
    ...
    public Value apply(Interpreter in, Environment env, Pair args) throws LispException {
        ...
        if (ftype == FType.SET_UNION)
            p1 = Lst.union(p1, p2, lastCdr1, lastCdr2, (x, y) -> Value.equal(x, y));
        else
            p1 = Lst.union(p1, p2, lastCdr1, lastCdr2, (x, y) -> Value.eq(x, y));
