...
public class SetDiff extends Func {

    public static enum FType { SET_DIFF, SETQ_DIFF }

    private final FType ftype;

    public SetDiff(FType ftype) {
    ...
    public Value apply(Interpreter in, Environment env, Pair args) throws LispException {
        ...
        if (ftype == FType.SET_DIFF)
            p1 = Lst.difference(p1, p2, lastCdr1, lastCdr2, (x, y) -> Value.equal(x, y));
        else
            p1 = Lst.difference(p1, p2, lastCdr1, lastCdr2, (x, y) -> Value.eq(x, y));
